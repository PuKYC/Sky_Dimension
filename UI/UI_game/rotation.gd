...
func on_control_started(_event: InputEventScreenTouch):
	camera_start_rotation = connect.get_camera_rotation()
...
func on_control_updated(event: InputEventScreenDrag):
	...
	connect.set_see_rotation(Vector3(
...
func _on_top_pressed() -> void:
	connect.set_verticale_up_input(1)


func _on_down_pressed() -> void:
	connect.set_verticale_down_input(1)


func _on_top_released() -> void:
	connect.set_verticale_up_input(0)
	


func _on_down_released() -> void:
	connect.set_verticale_down_input(0)
